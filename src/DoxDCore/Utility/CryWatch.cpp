...
namespace DoxD
{
	...
	static float GetWatchTextYPos()
	{
		...
		if (s_watchTextLastPrintedDuringFrame == frame)
		{
			...
			if (s_watchTextYPos + (g_pCVars->watch_text_render_size * g_pCVars->watch_text_render_lineSpacing) > gEnv->pRenderer->GetOverlayHeight())
			{
...
#include <CryRenderer/IRenderAuxGeom.h>
	...
	int CryWatchFunc(const char* message)
	{
		...
		if (gEnv && gEnv->pRenderer && g_pCVars && g_pCVars->watch_enabled)
		{
