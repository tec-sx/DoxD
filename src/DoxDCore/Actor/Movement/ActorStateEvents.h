...
namespace DoxD
{
	...
	{
		eActorEvent_PrePhysicsUpdate = eSE_Custom,
		eActorEvent_Update,
	...
	enum class EActorStateFlags : TBitfield
	{
		None = BIT32(0),
		PrePhysicsUpdateAfterEnter = BIT32(1),
		DoUpdate = BIT32(2),
		IsUpdating = BIT32(3),
		Ground = BIT32(4),
		Jump = BIT32(5),
		Sprinting = BIT32(6),
		SprintPressed = BIT32(7),
		Swimming = BIT32(8),
		InAir = BIT32(9),
		PhysicsSaysFlying = BIT32(10),
		CurrentItemIsHeavy = BIT32(11),
		InteractiveAction = BIT32(12),
		OnLadder = BIT32(13),
	};
